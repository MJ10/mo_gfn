...
class NupackTask(BaseTask):
    ...
    def score(self, candidates):
        ...
        """
        scores = nupack_score(candidates, objective=self.objectives)
        # make np.array and reshape
        return scores


def nupack_score(self, candidates, objectives="energy"):
    """
    ...
    # TODO: confirm if necessary, depending on format.
    sequences = self.numbers2letters(candidates)
